          ...
          {!isSubmitted ? (
            ...
            <div className="flex flex-col items-center text-center py-4">
              ...
              <p className="text-sm text-[var(--text-secondary)] mb-8">
                If this email exists, we sent a password reset OTP to <span className="font-semibold text-[var(--text-primary)]">{email}</span>.
              </p>
              <div className="mb-6 rounded-lg border border-[var(--warning)]/30 bg-[var(--warning)]/10 p-3 text-left text-sm leading-6 text-[var(--warning)]">
                The OTP is generated and delivered by the backend email service. If it does not arrive, check spam first, then verify the backend mail provider or development email logs.
              </div>
              
              <Link to="/verify-reset-code" state={{ email, userId: resetUserId }} className="w-full">

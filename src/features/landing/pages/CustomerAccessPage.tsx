...
const fallbackBusinesses: BusinessOption[] = [
  {
    id: demoBusinessId ?? "NXS-992-K",
    name: "Nexus Systems Inc.",
    industry: "Technology",
    description: "Advanced cloud infrastructure and automated workflow solutions for scaling startups.",
    icon: Building2,
  ...
  },
  {
    ...
    industry: "Healthcare",
    description: "Personalized wellness programs and remote patient monitoring services.",
    icon: HeartPulse,
  ...
  },
  {
    ...
    industry: "Featured",
    description: "Real-time supply chain visibility and automated freight forwarding globally.",
    icon: Truck,
    featured: true,
  ...
  },
  {
    ...
    name: "Apex Financial",
    industry: "Finance",
    description: "Smart asset management and digital banking infrastructure for modern enterprises.",
    icon: Landmark,
  ...
  },
  {
    ...
    name: "Prism Studio",
    industry: "Creative",
    description: "Digital branding, UI/UX design, and creative content production.",
    icon: Palette,
  ...
  },
  {
    ...
    name: "LearnStream AI",
    industry: "Education",
    description: "Adaptive learning platforms and enterprise training management systems.",
    icon: ShieldCheck,
...
export default function CustomerAccessPage() {
  ...
  const businessOptions = liveBusinesses?.length ? liveBusinesses : fallbackBusinesses;
      ...
      <main className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
          ...
          {filteredBusinesses.length === 0 && (
            <div className="mt-10 flex flex-col items-center rounded-md border-2 border-dashed border-[var(--border-default)] bg-[var(--bg-surface)]/80 px-6 py-12 text-center">
              <CircleHelp className="text-[var(--text-muted)]" size={38} />
              <p className="mt-4 font-semibold text-[var(--text-secondary)]">No businesses match your search.</p>
